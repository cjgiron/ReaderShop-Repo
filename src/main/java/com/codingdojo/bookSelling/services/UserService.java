...
import com.codingdojo.bookSelling.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {
        ...
        if(result.hasErrors()) {
            ...
            Cart cart = new Cart();
            cart = cartServ.createNewCart(cart);
            System.out.println(cart.getId());
            newUser.setCart(cart);
            System.out.println(newUser.getCart());
            userRepo.save(newUser);
            cart.setUser(newUser);
            cartServ.createNewCart(cart);
